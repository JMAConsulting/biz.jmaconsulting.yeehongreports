 ...
 * @copyright CiviCRM LLC (c) 2004-2017
 */
class CRM_Yeehongreports_Form_Report_UserLoggedInCMS extends CRM_Report_Form {
  ...
  public function from() {
    $cmsDatabase = DB::parseDSN(CIVICRM_UF_DSN);
    $this->_from = "
    ...
    $this->_from .= "
            INNER JOIN {$cmsDatabase['database']}.users {$this->_aliases['cms_users']}
                   ON {$this->_aliases['civicrm_uf_match']}.uf_id = {$this->_aliases['cms_users']}.uid ";
  }
